...
class Posts1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posts1" do
    assert_difference('Posts1.count') do
      post posts1s_url, params: { posts1: { body: @posts1.body, text: @posts1.text, title: @posts1.title, user_id: @posts1.user_id } }
    end
  ...
  test "should update posts1" do
    patch posts1_url(@posts1), params: { posts1: { body: @posts1.body, text: @posts1.text, title: @posts1.title, user_id: @posts1.user_id } }
